...
export default function Navigation() {
  ...
  const userAvatar =
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS4B1c-dIVDdMYhaR9HJ0SRZufvqIZY0zlOGw&s";
  ...
  return (
    ...
    <div className="container mx-auto bg-slate-700 drop-shadow-2xl p-8 grid grid-cols-3">
      <div>
        <nav>
          <Button variant="gabe">
