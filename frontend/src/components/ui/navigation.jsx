...
export default function Navigation() {
  return (
    ...
    <div className="container mx-auto bg-slate-700 drop-shadow-2xl p-8
    grid grid-cols-3">
      <div>
    <nav>
      
      <button className="bg-neutral-100 p-3 rounded-2xl focus:ring-2 
    ...
    <p className="text-slate-100 font-serif text-4xl">
       Egg 
    </p>
    </div>
